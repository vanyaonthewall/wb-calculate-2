...
export function Material({
  ...
  return (
    <div className="flex items-center gap-[var(--gap-2xs,8px)] pb-[var(--pad-s,16px)] border-b border-[var(--grey-150,#e0e0e0)] w-full last:border-b-0 last:pb-0">
      ...
      <div className="flex flex-1 items-center gap-[var(--gap-2xs,8px)] min-w-0">
        <div className="shrink-0 w-[72px] h-[72px] rounded-[var(--round-s,12px)] overflow-hidden bg-[var(--grey-150,#e0e0e0)]">
          {imageUrl && (
